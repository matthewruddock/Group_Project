...
public void AddVisitorRequest(VisitorRequest data) {
	...
	public void display() {
		VisitorRequest VR = null;
		System.out.println(VR.requestID+ "\t" + VR.visitor.getFirstName() + "\t" + VR.visitor.getLastName()+ "\t" 
				+ VR.visitor.getEmail() + "\t" + VR.place.getId() + "\t" + VR.place.getAttration() + "\t" 
				+ VR.getMessage() + "\t" + "\t" + VR.formattedDate + "\n");
